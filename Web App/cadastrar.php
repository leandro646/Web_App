                 ...
                 <form action="cadastrar.php" method="POST">
                     ...
                     <div class="col-12 d-flex">
                         <div class="mb-4 me-3">
                             ...
                             <input type="email" class="form-control" name="login" id="email" placeholder="Login" required>
                         </div>
                     </div>
                     <button type="submit" name="submit" class="btn btn-dark w-100 mb-3 mt-1">Confirmar</button>
                     <p class="text-center"><a class="link-opacity-75 link-opacity-100-hover link-dark" href="index.php">Fazer login</a></p>
                 </form>
             </div>
         </div>
     </div>
